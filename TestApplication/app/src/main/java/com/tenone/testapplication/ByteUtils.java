...
public class ByteUtils
{
	...
	private static char[] statArr = new char[MAX_PACKET_SIZE*10];
	 ...
	 */
	public static String getAsString(byte[] thePacket)
	{
	 ...
	 * @return string
	 */
	public static String getAsString(byte[] thePacket, int startidx, int endidx)
	{
	 ...
	 * @return string
	 */
	public static String getAsString(byte[] thePacket, int startidx, int endidx, int maxInLine)
	{
		int idx=0;
		for(int i=startidx ; i<endidx ; i++)
		{
